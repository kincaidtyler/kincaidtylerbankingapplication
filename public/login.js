...
function LoginForm(props) {
  ...
  function handleGoogle() {
    ...
    .then((result) => {
        // Receives Google Access Token to access the Google API.
        ...
        fetch(`/users/findOne/${user.email}`)
          ...
          .then(text => {
              try {
                ...
                // Connect to MongoDb
                const url = `/user/create/${username}/${Email}/${password}`;
                (async () => {
