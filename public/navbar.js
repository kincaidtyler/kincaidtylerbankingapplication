  ...
  return(
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark stroke">
      <div className="container-xl">
        <a className="navbar-brand navbar-dark fw-bold"><img className="mr-2" src="./capstone_logo.png" alt="Bank logo"/>Capstone Bank</a>
        ...
        <div className="float-end">
          <span className="fw-bold mt-1 text-white" id="loggedInStatus">Log In or Sign Up</span>
        </div>
      </div>
    </nav>
  );
